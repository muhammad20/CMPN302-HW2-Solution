...
# large array to make time difference between reursive and non recursive
data_count = 10000000
unsorted_data_file = "p3_data.in"  # the file to generate data in.
output_data_file = "p3_data.out"  # the file where the output of code exists.
...
os.system("g++ -std=c++11 hw2_p3.cpp -o output")
